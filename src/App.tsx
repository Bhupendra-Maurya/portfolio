...
const projects = [
  {
    ...
    "description": "Developed a static e-commerce website with a responsive and accessible user experience. Designed a clean, visually appealing layout adhering to modern design principles.",
    image:
  ...
  },
  {
    ...
    "description": "Developed a feature-rich task management application that enables users to add, filter, complete, and delete tasks, with statistics to track task statuses. React Context API for centralized state management.",
    ...
    liveLink: "https://github.com/Bhupendra-Maurya/Task-Management-Application",
    githubLink: "https://github.com/Bhupendra-Maurya/Task-Management-Application",
  },
  {
    title: "Admin Dashboard",
    "description": "Angular based Admin Dashboard for user and role management, incorporating comprehensive CRUD operations.Simulated backend operations using JSON Server for efficient local development and testing.",
...
const App = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        "service_ix6u4zq", // Replace with your Service ID
        "template_to210jr", // Replace with your Template ID
        {
          ...
          to_name: "Bhupendra", // Your name
        },
        "tAj-V_vIxmUaCPgPh" // Replace with your Public Key
      );
